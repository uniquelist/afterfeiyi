...
public class Declarer {
    ...
    //项目类型
    private List<com.feiyi.domain.Category> categoryList;
    //民族
    private List<com.feiyi.domain.Nation > nationsList;
    //项目编号
    private List<com.feiyi.domain.Projects> projectsList;
